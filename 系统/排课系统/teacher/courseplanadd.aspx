<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courseplanadd.aspx.cs" Inherits="排课系统.teacher.coursetaskadd" %>
                ...
                <div class="result-wrap">
                    ...
                    <div class="result-content">
                        <ul class="sys-info-list">
                            ...
                            <li>
                                    <label class="res-lab">教室</label><asp:TextBox ID="txtClassRoom" runat="server"
                                    class="common-text" placeholder="1-16"
                                    Height="25px" Width="341px"></asp:TextBox>
                            </li>
                            <li>
