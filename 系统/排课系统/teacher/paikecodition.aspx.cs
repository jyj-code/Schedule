...
namespace 排课系统.teacher
{
    public partial class paikecodition : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            string sql = "insert into t_taboo(weekdays,sections,weeksstart,weeksend,tabootype,teachid,shenhe) values('" + DropDownList1.SelectedIndex.ToString()
                + "','" + DropDownList2.SelectedIndex.ToString() + "','" + DropDownList3.SelectedIndex.ToString() + "','" + DropDownList4.SelectedIndex.ToString() + "','0','" + Session["teachid"].ToString() + "','1')";
