<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentmanadd.aspx.cs" Inherits="排课系统.Student.studentmanadd" %>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">学生学号</label><asp:TextBox ID="txtUserNo" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">学生姓名</label><asp:TextBox ID="txtUserName" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">学生专业</label><asp:TextBox ID="txtmajor" runat="server" class="common-text"
                            Height="25px" Width="341px"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">学生年级</label><asp:TextBox ID="txtgrade" runat="server" class="common-text"
