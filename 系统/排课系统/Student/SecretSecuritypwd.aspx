<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecretSecuritypwd.aspx.cs" Inherits="排课系统.Student.SecretSecuritypwd" %>
        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    <li>
                        <label class="res-lab">密保问题</label><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                    </li>
                    <li>
                        <label class="res-lab">密保答案</label><asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                    </li>
                        <li>
                        <label class="res-lab">确认密保答案</label><asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                    </li>
                    <li>
