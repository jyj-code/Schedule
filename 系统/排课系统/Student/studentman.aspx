<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentman.aspx.cs" Inherits="排课系统.Student.studentman" %>
                ...
                <div class="result-content">
                     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" PageSize="15" 
                         ...
                         <Columns>
                            ...
                            <asp:BoundField DataField="zhicheng" HeaderText="学生班级" />
                            <asp:BoundField DataField="xueli" HeaderText="学生年级" />
